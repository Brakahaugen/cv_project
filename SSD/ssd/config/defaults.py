...
cfg.MODEL.BACKBONE.OUT_CHANNELS = (128, 256, 512, 512, 256, 256, 128) #(128, 256, 512, 256, 256, 128, 128) #(512, 1024, 512, 256, 256, 256)
...
cfg.MODEL.PRIORS = CN()
cfg.MODEL.PRIORS.FEATURE_MAPS = [[60,80], [30,40], [15, 20], [8, 10], [4, 5], [2, 3], [1, 1]]
#[[30,40], [21, 20], [11, 10], [6, 5], [4, 3], [2, 1]] #[38, 19, 10, 5, 3, 1]

cfg.MODEL.PRIORS.STRIDES = [[4,4], [8,8], [16,16], [30, 32], [60, 64], [120, 107], [240,320]] # [2,2], [1,1], [1,1], 
#[[8,8], [16,16], [30, 32], [60, 64], [120, 107], [240,320]]
cfg.MODEL.PRIORS.MIN_SIZES = [2, 5, 15, 30, 60, 111, 162]
cfg.MODEL.PRIORS.MAX_SIZES = [40, 60, 111, 162, 213, 264, 315]
cfg.MODEL.PRIORS.ASPECT_RATIOS = [[2], [2], [2, 3], [2, 3], [2, 3], [2], [1]]
...
cfg.INPUT = CN()
# Image size
cfg.INPUT.IMAGE_SIZE = [320, 240] #300
